...
async function sendFreeResultsEmail(to, jobTitle, data, resultUrl) {
  ...
  const html = '<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>'
    ...
    + '<p style="margin:0 0 20px;"><a href="https://tally.so/r/rjYkJv" style="color:#2D1B69;font-size:14px;font-weight:700;text-decoration:underline;">https://tally.so/r/rjYkJv</a></p>'
    ...
    + '</td></tr></table>'
    + '<p style="margin:0 0 28px;font-size:14px;color:#0A0A0A;">- Farzana</p>'
