...
export default function FirstImpression({ data }) {
  return (
    <motion.div
    ...
    >
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <div style={{ fontSize: '1.5rem', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.2 }}>{data.headline}</div>
      </div>

      <div className="insight-block" style={{ marginBottom: '1.5rem' }}>"{data.sixSecondRead}"</div>
